//
//  LTChangPasswordController.swift
//  langTao
//
//  **********************************************
//  *     _    _        _ˍ_ˍ_        _    _      *
...
class LTChangPasswordController: LTViewController {
    let source = ["Enter new password".localString, "Enter new password again".localString, "Done".localString]
    var password = ""
    var cheakPassword = ""

    override func viewDidLoad() {
        super.viewDidLoad()
        title = "Change Password".localString
    ...
    @objc func buttonsAction(_ btn: UIButton) {
        ...
        LTUserViewModel.shared.modiyUserinfo(param: ["id" : user.data.user.id, "password" : password]) { [weak self] (result) in
...
extension LTChangPasswordController: UITableViewDelegate, UITableViewDataSource {
